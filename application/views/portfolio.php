...
<?php foreach($creations as $creation): ?>
	...
	<div class="item element <?=$classes?>">
		<a class="item-image" href="http://localhost/portfolio/detail/<?=$creation->id?>" data-btn-func="close" data-toggle="modal" data-title="<?=$creation->title?>" data-subtitle="<?=$creation->subtitle?>">
